...
const ReportsFilter = ({
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        const managers = res.data.staff.filter(
      ...
      <div className="flex gap-8">
        <div className="flex gap-2 items-start mt-4 flex-col">
          ...
          <select
            ...
            value={selectedArea}
            className="select select-bordered rounded-lg max-w-xs font-semibold gradientselect w-[150px] px-3 py-1"
          >
        ...
        <div className="flex gap-2 items-start mt-4 flex-col">
          ...
          <DatePicker
            ...
            className="input input-bordered rounded-lg w-full max-w-md px-2"
          />
        </div>
