    ...
    <dialog className="modal modal-bottom sm:modal-middle" open>
      <div className="modal-box pt-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <input id="description" type="text" placeholder="Description" {...register("description")} className="input input-bordered" />
          ...
          <div className="w-full flex flex-col items-start gap-2">
            ...
            <label className="w-full relative">
              <select {...register("status")} className="select input-bordered w-full">
          ...
          <div className="w-full flex flex-col items-start gap-2">
            ...
            <label className="w-full">
              <select {...register("assignedTo")} multiple className={`select input-bordered w-full ${errors.assignedTo ? "input-error" : ""}`}>
