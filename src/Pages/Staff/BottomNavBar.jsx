...
export default function BottomNavBar() {
  ...
  return (
    <div className="flex justify-between fixed bottom-0 w-full bg-base-300 border-[1px] border-neutral-content border-opacity-25 ">
      <NavLink to="staff/areas" className="p-2">
      ...
      <NavLink to="staff/dashboard" className="p-2">
        <div className="flex flex-col items-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            <path
              strokeLinecap="round"
      ...
      <button onClick={() => nav("profile")} className="flex flex-col items-center p-2">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      <button onClick={() => logout()} className="flex flex-col p-2 items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
