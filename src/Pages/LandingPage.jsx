    ...
    <div className="font-normal m-auto bg-[#ffffff]">
      ...
      <main>
        <section className="bg-white relative mt-36" data-aos="fade-up">
          <div className="relative z-10 max-w-screen-xl mx-auto flex flex-col-reverse lg:flex-row items-center px-4 sm:px-6 lg:px-8 py-10">
            <div className="lg:w-1/2 text-start" data-aos="fade-right">
              <h2 className="text-3xl sm:text-5xl lg:text-5xl font-extrabold mb-8 text-left text-primary">Keep track, optimise resources with AI</h2>
        ...
        <section className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-28" data-aos="fade-up">
          <h2 className="text-4xl font-extrabold text-center mb-6 text-primary">What we provide</h2>
          <p className="text-lg text-black leading-relaxed mb-12">
            We are committed to enhancing our clients’ operations through the power of QR technology and AI. Our mission is to streamline processes
            and optimize performance, enabling businesses to run more efficiently and effectively. By leveraging cutting-edge innovations, we help our
            clients stay competitive and achieve long-term success.
          </p>
              ...
              <Slider {...sliderSettings} className="w-full">
                <div className="flex justify-center items-center p-4">
                  <div className="flex justify-center items-center w-full h-full">
                    <img src={dashboardUI} alt="Description 1" className="max-[1400px] h-auto object-contain" />
                  </div>
                </div>
                <div className="flex justify-center items-center p-4">
                  <div className="flex justify-center items-center w-full h-full">
                    <img src={advisorUI} alt="Description 2" className="max-[1400px] h-auto object-contain" />
                  </div>
                </div>
                <div className="flex justify-center items-center p-4">
                  <div className="flex justify-center items-center w-full h-full">
                    <img src={peopleUI} alt="Description 3" className="max-[1400px] h-auto object-contain" />
                  </div>
                </div>
              </Slider>
            </div>
        ...
        <section className="bg-indigo-100 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-44 mb-44 w-full rounded-xl shadow-lg">
          <div className="container mx-auto grid grid-cols-1 gap-20 text-center">
            <div>
              ...
              <p className="text-lg text-black leading-relaxed mb-12">
                Have you ever thought about getting rid of all the tracking paper sheets and modernizing your operation? We're here to help!
              </p>
              <form action="">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="form-control">
                    ...
                    <textarea
                      ...
                      className="textarea textarea-bordered w-full bg-slate-50 h-full"></textarea>
                  </div>
                </div>
                  ...
                  <div className="flex items-start justify-start">
                    <label htmlFor="agree" className="label cursor-pointer flex items-start">
                      ...
                      <span className="label-text text-sm text-black text-left">
                        <span className="text-red-500">*</span> By submitting this message, I confirm that I have read and agree to the terms of use
            ...
            <div className="p-8 rounded-xl bg-indigo-200">
              <div className="mb-12 text-center">
                <span className="block text-2xl font-bold mb-6 text-indigo-900">Get in touch</span>
                <p className="text-lg leading-relaxed text-indigo-900">We love to hear from you. Our team is always here to chat.</p>
              </div>
              <address className="not-italic flex flex-col lg:flex-row lg:justify-evenly">
                <div className="flex items-center mb-6 lg:mb-0">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-indigo-800 text-start">Tierstr. 119, Leipzig, Germany</p>
                  </div>
                </div>
                <div className="flex items-center mb-6 lg:mb-0">
                  <div className="bg-primary p-4 rounded-full text-white text-2xl">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-indigo-800 text-start">+49 186 73636 838</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <div className="bg-primary p-4 rounded-full text-white text-2xl">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-indigo-800 text-start">hello@snaptask.com</p>
                  </div>
                </div>
              </address>
            </div>
