      ...
      <main>
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="text-xl mt-4 uppercase text-primary text-2xl font-medium ">
                <h3>Healthcare</h3>
              </div>
              <div className="text-xl mt-4 uppercase text-primary text-2xl font-medium">
                <h3>Restaurants</h3>
          ...
          <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <p className="text-lg text-black leading-relaxed mb-12">
                Have you ever think about get rid of all the tracking paper
                sheets and modernize your operation? We're here to help!
              </p>
                ...
                <div className="form-control flex items-start">
                  ...
                  >
                    ...
                    <span className="label-text text-sm text-black text-left">
                      ...
                      message, I confirm that I have read and agree to the terms
                      of use and privacy policy of SnapTask.
                    </span>
                  </label>
                </div>
