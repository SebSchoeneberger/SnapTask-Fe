  ...
  return (
    <div className="font-normal m-auto bg-[#ffffff]">
      ...
      <main>
          ...
          <div className="relative z-10 max-w-screen-xl mx-auto flex flex-col-reverse lg:flex-row items-center px-4 sm:px-6 lg:px-8 py-10">
            <div className="lg:w-1/2 text-start" data-aos="fade-right">
              <h2 className="text-3xl sm:text-5xl lg:text-5xl font-extrabold mb-8 text-left text-primary">
                Keep track, optimise resources with AI
              </h2>
              <p className="text-sm lg:text-lg mb-10 text-left text-black">
                ...
                priorities, and achieve your goals with ease. Whether you're
                managing a busy schedule, coordinating with a team, or looking
                to enhance your productivity, Snap Tasks offers innovative
                solutions tailored to your needs leverage in AI.
              </p>
              <Link
                to="/signup"
        ...
        <section
          className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-52 bg-purple-50 rounded-xl shadow-lg"
          data-aos="fade-up"
        >
          ...
          <p className="text-lg font-normal text-center mb-8 text-black">
            Our solutions are ideal for busy professionals, team leaders, and
            anyone looking to enhance their organizational skills and
            productivity.
          </p>
              ...
              >
                ...
                <div className="card-body opacity-0 group-hover:opacity-100 flex items-center justify-center absolute inset-0 transition-opacity duration-300 ease-in-out">
                  <ul className="text-white text-sm list-disc text-left flex flex-col gap-5">
                    ...
                    <li>
                      Get informed about the performance of your employees
                    </li>
                    <li>
                      Get informes about what are the areas that use more
                      resources
                    </li>
                  </ul>
                </div>
        ...
        <section
          className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-28"
          data-aos="fade-up"
        >
          <h2 className="text-4xl font-extrabold text-center mb-6 text-primary">
            What we provide
          ...
          <p className="text-lg text-black leading-relaxed mb-12">
            We are committed to enhancing our clients’ operations through the
            power of QR technology and AI. Our mission is to streamline
            processes and optimize performance, enabling businesses to run more
            efficiently and effectively. By leveraging cutting-edge innovations,
                ...
                <div className="flex justify-center items-center p-4">
                  <div className="flex justify-center items-center w-full h-full">
                    <img
                      src={dashboardUI}
                      alt="Description 1"
                      className="max-[1400px] h-auto object-contain"
                    />
                  </div>
                </div>
                <div className="flex justify-center items-center p-4">
        ...
        <section
          className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-44 mb-44 bg-green-100 w-full rounded-xl shadow-lg"
          data-aos="fade-up"
        >
          <h2 className="text-4xl font-extrabold text-center mb-6 text-primary">
            Meet Our Team
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div
              className="p-6 rounded-lg drop-shadow-lg"
              data-aos="fade-right"
            >
              <img
                src={person1Image}
                alt="Daniel Avery"
                className="mb-6 max-w-full h-auto border-0"
              />
        ...
        <section className="bg-indigo-100 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-44 mb-44 w-full rounded-xl shadow-lg">
          <div className="container mx-auto grid grid-cols-1 gap-20 text-center">
            <div>
              ...
              <h2 className="text-4xl font-bold text-neutral mb-8">
                Have a question?
              </h2>
              <p className="text-lg text-black leading-relaxed mb-12">
                Have you ever thought about getting rid of all the tracking
                paper sheets and modernizing your operation? We're here to help!
              </p>
              <form action="">
                ...
                <div className="mt-4 w-full flex items-center justify-center flex-col">
                  <div className="flex items-start justify-start">
                    <label
                      htmlFor="agree"
                      className="label cursor-pointer flex items-start"
                    >
                      <input
                        required
                        type="checkbox"
                      ...
                      <span className="label-text text-sm text-black text-left">
                        <span className="text-red-500">*</span> By submitting
                        this message, I confirm that I have read and agree to
                        the terms of use and privacy policy of SnapTask.
                      </span>
                    </label>
                  </div>
            ...
            <div className="p-8 rounded-xl bg-indigo-200">
              ...
              <address className="not-italic flex flex-col lg:flex-row lg:justify-evenly">
                <div className="flex items-center mb-6 lg:mb-0">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-indigo-800 text-start">
                      Tierstr. 119, Leipzig, Germany
                    </p>
                  </div>
                </div>
                <div className="flex items-center mb-6 lg:mb-0">
      ...
      <footer className="bg-white text-base-content p-10 mx-auto max-w-screen-xl pt-16">
        <div className="flex flex-wrap justify-between">
          <aside className="w-full sm:w-1/2 lg:w-1/5 mb-6">
            ...
            <p className="font-bold mt-6 text-start">
          ...
          <nav className="w-full sm:w-1/2 lg:w-1/5 mb-6">
            <h6 className="footer-title text-primary flex items-start">
              Support
            </h6>
            <ul className="font-bold flex flex-col items-start">
              <li className="mb-2">
