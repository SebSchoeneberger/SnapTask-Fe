      ...
      <header className="relative z-20 px-4 sm:px-6 lg:px-8 py-4" data-aos="fade-down">
        <div className="flex items-center justify-between max-w-screen-xl mx-auto">
          ...
          <div className="hidden sm:flex gap-4">
            <Link to="/login" className="bg-[#40446b] text-white px-4 py-2 rounded-lg font-semibold hover:bg-[#7e5035] transition-colors duration-300">Login</Link>
            <Link to="/signup" className="bg-[#40446b] text-white px-4 py-2 rounded-lg font-semibold hover:bg-[#7e5035] transition-colors duration-300">Sign Up</Link>
          </div>
        </div>
      </header>
      ...
      <main>
          ...
          <div className="relative z-10 max-w-screen-xl mx-auto flex flex-col-reverse lg:flex-row items-center px-4 sm:px-6 lg:px-8 py-10">
            <div className="lg:w-1/2" data-aos="fade-right">
              ...
              <p className="text-sm lg:text-lg mb-6">
                At Snap Tasks, we understand that organizing tasks can be overwhelming. Our mission is to simplify your life by providing a powerful platform that helps you 
                streamline your tasks, set priorities, and achieve your goals with ease. Whether you're managing a busy schedule, coordinating with a team, or looking to enhance
                your productivity, Snap Tasks offers innovative solutions tailored to your needs.
              </p>
              <Link to="/signup" className="bg-[#40446b] text-white w-full sm:w-auto py-3 px-6 rounded-lg font-semibold hover:bg-[#7e5035] transition-colors duration-300 text-center">
                Get Started
              </Link>
            </div>
        ...
        <section className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-52" data-aos="fade-up">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card bg-base-100 image-full shadow-xl group relative" data-aos="zoom-in">
              <figure>
                <img src={hospitalsImage} alt="Expert Guidance" className="group-hover:brightness-50 transition duration-300 ease-in-out" />
              </figure>
            ...
            <div className="card bg-base-100 image-full shadow-xl group relative" data-aos="zoom-in">
              <figure>
                <img src={industryImage} alt="Personalized Service" className="group-hover:brightness-50 transition duration-300 ease-in-out" />
              </figure>
              <div className="card-body opacity-0 group-hover:opacity-100 flex items-center justify-center absolute inset-0 transition-opacity duration-300 ease-in-out">
            ...
            <div className="card bg-base-100 image-full shadow-xl group relative" data-aos="zoom-in">
              <figure>
                <img src={roommatesImage} alt="Transparent Process" className="group-hover:brightness-50 transition duration-300 ease-in-out" />
              </figure>
              <div className="card-body opacity-0 group-hover:opacity-100 flex items-center justify-center absolute inset-0 transition-opacity duration-300 ease-in-out">
        ...
        <section className="bg-[#ffffff] py-24 text-center mt-52" data-aos="fade-up">
          <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-black mb-6">
              We are here for you. Contact us for any inquiries or support.
            </p>
        ...
        <div className="flex flex-wrap justify-between">
          ...
          <nav className="w-full sm:w-1/2 lg:w-1/5 mb-6" data-aos="fade-right">
            ...
            <ul className="font-bold flex flex-col">
              <li className="mb-2"><Link to="#" className="link link-hover">Our Story</Link></li>
              <li className="mb-2"><Link to="#" className="link link-hover">Careers</Link></li>
              <li className="mb-2"><Link to="#" className="link link-hover">Our Team</Link></li>
              <li className="mb-2"><Link to="#" className="link link-hover">Resources</Link></li>
            </ul>
          </nav>
          ...
          <nav className="w-full sm:w-1/2 lg:w-1/5 mb-6" data-aos="fade-right">
            ...
            <ul className="font-bold flex flex-col">
              <li className="mb-2"><Link to="#" className="link link-hover">FAQ</Link></li>
              <li className="mb-2"><Link to="#" className="link link-hover">Contact Us</Link></li>
              <li className="mb-2"><Link to="#" className="link link-hover">Help Center</Link></li>
            </ul>
          </nav>
          ...
          <nav className="w-full sm:w-1/2 lg:w-1/5 mb-6" data-aos="fade-left">
            ...
            <ul className="font-bold flex flex-col">
              <li className="mb-2"><a href="mailto:info@snaptask.com" className="link link-hover">Email Us</a></li>
              <li className="mb-2"><a href="#" className="link link-hover">Support</a></li>
              <li className="mb-2"><a href="#" className="link link-hover">Locations</a></li>
            </ul>
          </nav>
        </div>
      </footer>
