        ...
        <div>
          <div className="flex gap-4 items-center mt-6 mb-6">
            ...
            <select
              ...
              value={selectedArea}
              className="font-semibold gradientselect w-[150px] px-3 py-1 bg-base-300 rounded"
            >
        ...
        <div className="flex flex-col gap-6 ">
          ...
          {!loadingTasks ? (
            <div className="overflow-x-auto rounded-md ">
              <table className="table table-sm w-full bg-base-200 rounded-md shadow-md">
